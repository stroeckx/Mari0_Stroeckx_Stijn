...
void DOUBLE2::normalize()
{
	__m128 v = _mm_setr_ps(float(x), float(y), 0, 0);
	//bitmask: 0011 0011 -> result stored in two variables: x, y
	__m128 inverse_norm = _mm_rsqrt_ps(_mm_dp_ps(v, v, 0x33));
